            ...
            <div class="community-content__right">
                ...
                <div class="community-times">
                    <div class="community-time">
                        <span class="community-time__head community-time__head--start">開始日時</span><span class="d-inline-block">{{ $community->getDateAndTime($community->start_time) }}</span></div>
                    <div class="community-time"><span class="community-time__head community-time__head--end">終了日時</span><span class="d-inline-block">{{ $community->getDateAndTime($community->end_time) }}</span></div>
                </div>
